...
int start()
{
      ...
      {  
         ...
         if(random==25){
            ...
            //   Print("ObjectCreateERROR:  "+GetLastError());
            //}else{
            //   Print("ObjectCreateSUCCESS:  "+GetLastError());
            //}
         ...
         if(random==75){
            ...
            //if(!ObjectCreate("ObjName", OBJ_LABEL, 0, D'2007.02.19 12:30', 0)){
            //   Print("ObjectCreateERROR:  "+GetLastError());
            //}else{
            //   Print("ObjectCreateSUCCESS:  "+GetLastError());
            //}
            //ObjectSetText("ObjName","your Text",0, "Verdana", Red);
            //Print("ObjectSetText");
            //ObjectSet("ObjName", OBJPROP_CORNER, 0);
            //Print("ObjectSet");
            ///ObjectSet("ObjName", OBJPROP_XDISTANCE, 20);
